public class Carattere {
    ...
    public void encode(char c) {
        ...
        for (int i = 0; i < 8; i++) { // Ciclo per gli 8 bit: Il metodo utilizza un ciclo for per iterare attraverso gli 8 bit della rappresentazione binaria del carattere.
            ...
            int numero = this.bytes[i].getNumero(); // Metodo getNumero nella classe Byte: È stata aggiunta una nuova funzione getNumero nella classe Byte per consentire l'accesso al valore del numero intero rappresentato dal byte.
